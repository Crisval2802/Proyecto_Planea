...
from .views import API_Avances, API_Intento, API_Login, PadronAlumnos, RegistrarAlumno, API_Examen, API_Inicio, Inicio, Login, Logout, RegistrarAlumno, RegistrarUsuario, agregar_examen, agregar_materia, agregar_pregunta, agregar_rama, generar_reporte, Examen
...
urlpatterns=[ 
    ...
    path('reporte/alumno/<int:idAlumno>/<int:idExamen>', generar_reporte, name="generar_reporte"),
    
    #URLS de la api para consumirlas desde flutter
    path('api/login/<str:username>/<str:password>/', API_Login.as_view(), name='api_login'),
    path('api/inicio/', API_Inicio.as_view(), name='api_inicio'),
    path('api/examen/<int:id>', API_Examen.as_view(), name='api_examen'),
    path('api/avances', API_Avances.as_view(), name='api_avances'),
